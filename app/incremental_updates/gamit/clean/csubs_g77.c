/* X wrappers for CVIEW -- Sun (OS/4 Solaris 2) and DEC OSF1 (with _ before sb name)
...
int gsetup_(ibmx0,ibmy0,bmwdth,bmhght,lcolor,csize,ipos)
...
void gline_(ix1,iy1,ix2,iy2,igerr)
