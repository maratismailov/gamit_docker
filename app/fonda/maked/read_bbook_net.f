      subroutine read_bbook_net(ifil1,ifil2,ifil3,nnet,netfmt,
     .                          iesit,sname,rtime)
c
...
c
      ...
      integer   ii,remedy_space,iesit(200),ifil1,ifil2,ifil3,k,nnet
c      
...
c     default format
      if (netfmt(1:1).eq.'*')
     . netfmt(1:42) = '(7x,i2,1x,i3,1x,a16,13x,2(i3,i2,i7,a1),i6)'
...
c        restore real number second and heght
         sla = dble(las)*1.0d-5
         slo = dble(los)*1.0d-5
         ht = dble(iht)*1.0d-2
