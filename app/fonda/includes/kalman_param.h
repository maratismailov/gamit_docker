...
*                   Each is read in the sequence given.
      ...
      integer*4 max_eq, max_rn, max_eq_cmd, max_apr_files,
...
*                                       ! 40 global parameters can be markov
      parameter ( max_glb_mar    = 4096 )
 
*                                       ! 256 parameters in global solution
      parameter ( max_glb_parn   = 8192 )
 
*                                       ! Max 32 VLBI sites
      parameter ( max_glb_sites  = 2048 )
 
      parameter ( max_glb_site_wrds = (max_glb_sites-1)/32+1 )
 
      parameter ( max_etd_sites  = 32 )
 
*                                       ! 5000 experiments in one solution
      parameter ( max_glb_sol   = 5000)
...
*                                              ! add 64 to allow for
*                                              ! end of record. 
      parameter ( max_glbapr_sz = 2*max_glb_parn+64 ) 
...
*                                       ! Up to 180 transission elements
      parameter ( max_trans_col  = 4096 )
*                                       ! transissions affecting up to 60
      parameter ( max_trans_row  = 4096 )
*                                       ! parameters
...
*        agreement 
      parameter ( globk_version  = '5.05' )
      parameter ( globc_version  = '5.05' )
      parameter ( glbak_version  = '5.00' )
      parameter ( glist_version  = '5.01' )
      parameter ( glorg_version  = '5.04' )
...
* max_ss  -- Maximum number of site sigmas allowed.
      ...
      parameter ( max_nonsec = 2056 )
      parameter ( max_ss     = 2056 )     
