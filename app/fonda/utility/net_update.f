      program net_update
c
c     update apriori coordinate and velocitiy values
c
c     options:
c        1 = update all 3d
c        2 = update all 2d
...
c     check if the runstring is complete.
      ...
      if (l1.le.0.or.l2.le.0.or.len.le.0) then
         print*,' Runstring: net_update <infile> <outfile>',
     .      ' <modfile> <option>'
...
c     open file
      ...
      print*,' Begin to update the network file ...'
c
...
c        copy comment lines
         if (line(1:1).ne.' ') then
            ...
            if (line(3:7).eq.'histo') then
               ...
               write (12,'(a16,a,a8,i4,2(a1,i2),3x,i2,2(a1,i2))')
     .            '* updated from: ',infile(1:len),'  time: ',
