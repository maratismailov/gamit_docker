...
*                   - series is regularized, tides removed)
*   SD_pr           - Series has short period tides present.
 
      character*8 UT1_sm, UT1_pr, UT1_sec, SD_pr
 
*   out_ex          - Name of output file for smoothed series
...
*                   - residuals
      ...
      character*128 out_ex, in_pr, out_pr, in_sec, out_sec
...
* COMMON DECLARATION
     ...
     .    UT1_sec, SD_pr, out_ex, in_pr, out_pr, in_sec, out_sec
