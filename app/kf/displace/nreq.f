      ...
      subroutine okada(X,Y,DEP,DIP,AL,AW,d1,d2, d3,U1,U2,U3)
C***** SAMPLE subroutine FOR SURFACE DEFORMATION
* MOD TAH 190104: Added tensile component d3 (after d1,d2) to calling 
*     arguments.

      real*8 X,Y,DEP,DIP,AL,AW,d1,d2,U1,U2,U3
      real*8 F0, F1, EPS
      real*8 RAD, ALP, sd, cd, d3
      real*8 u11, u12, u21, u22, u31, u32
                        
c      IMPLICIT DOUBLE PRECISION  (A-H,O-Z)                                        
      integer ktype 

      DATA  F0, F1, EPS / 0.D0, 1.D0, 1.D-3 /                           
      RAD=6.283185307179586D0/3.6D2                                     
      ALP=0.5D0                                                         
C*****                                                                  
      ktype = 2
* MOD TAH 190104: Removed setting d3 to zero since now passed
*     d3=0.0
      SD=DSIN( DIP*RAD )                                                
      CD=DCOS( DIP*RAD )                                                
      IF(DABS(CD).GT.EPS)  GO TO 10                                     
      CD=F0                                                             
      IF(SD.GT.F0)  SD= F1                                              
      IF(SD.LT.F0)  SD=-F1                                              
C*****                                                                  
C***** IN CASE OF POINT SOURCE                                          
C*****                                                                  
   10 IF(KTYPE.EQ.2)  GO TO 20                                          
C*****                                                                  
C***** IN CASE OF FINITE FAULT                                          
C*****                                                                  
20      continue
      CALL SRECTF(ALP,X,Y,DEP,AL,AW,SD,CD,D1,D2,D3,                     
     *               U1,U2,U3,U11,U12,U21,U22,U31,U32)                  
C*****                                                                  
  610 FORMAT(  1H ,1P9E14.3)                                            
   90 return                                                            
      END                                                               
...
C*****                                                                  
      real*8 X,Y,DEP,DIP,AL,AW,d1,d2
      real*8 U1,U2,U3,U11,U12,U21,U22,U31,U32
      real*8 F0, F1, f2, f3, f4, f5, f8, f9, EPS, pi2
      real*8 d, dr, rd, r12, r32, r33, r53, r54
      real*8 a1, a2, a3, a4, a5
      real*8 b1, b2, b3, b4, b5
      real*8 c1, c2, c3, c4, c5
      real*8 un, qrx, fx, sdcd, qrp, fs, sdsd, qrq, fq

      real*8 RAD, ALP, sd, cd, d3, DISL1,DISL2,DISL3
      real*8 p,q,s, x2,y2,xy, r2,r, r3,r5,qr,xr, yr, xyr
...
C*****                                                                  
c      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      real*8 ALP,X,Y,DEP,AL,AW,SD,CD,DISL1,DISL2,DISL3,     
     .                   U1,U2,U3,U11,U12,U21,U22,U31,U32                                         
      integer i,j,k,jk
      real*8  U(9),DU(9)
      real*8 f0, f1, p, q, et, xi, sign
...
C*****                                                                  
c     IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      real*8 ALP,XI,ET,Q,SD,CD,DISL1,DISL2,DISL3,           
     .                   U1,U2,U3,U11,U12,U21,U22,U31,U32
      real*8 f0, f1, f2, pi2
      real*8 xi2, et2, q2, r2, r, r3, d, y, ret, rd, rrd, tt
      real*8 re, dle, rrx, rre, axi, aet, td, x
      real*8 a1, a2, a3, a4, a5, c1, c2, c3, b1, b2, b3, b4, rd2
