CTITLE OUT_GLBL
      ...
      subroutine out_glbl(iout, parn, est,sol,cov, ndimc, conversion,
...
c     to deg, min, sec)
c ndimc  -- dimension of COV covaraince matrix
 
      integer*4 iout, parn, type, ndimc
 
c
      real*8 est, sol(1), cov(ndimc,1), conversion
...
*  scr_real(1) = sol(parn)*conversion      - convert to ouput units
         ...
         scr_real(2) = sqrt(cov(parn,parn))*conversion
