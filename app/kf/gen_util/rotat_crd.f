ctitle
      ...
      subroutine rotat_crd(in_comp,out_comp, in_sys,out_sys,
...
c
      ...
      real*8 in_comp(1), out_comp(1), site_pos(1), loc_coord(1),
     .    rot_matrix(3,1)
 
*   i,j,k       - Loop counters
*   id          - Dummy argument for loglu
*   loglu       - HP function to return users terminal
 
      integer*4 i,j, id, loglu
...
c        of this matrix if we wish to go NEU to XYZ)
         call xyz_to_neu(rot_matrix, site_pos, loc_coord)
c
