      ...
      subroutine short_period_ut1( jd, dut1)
 
      implicit none 

 
*     Routine to compute the short period UT1 tidal contributions
...
*   dut1    - Tidal contribution to UT1
...
*   t       - Julian centuries since J2000
      ...
      real*8 arg, dj2000, dut1, jd, el, elp, f, d, om, seccon, t
...
*     Now start the summation (only do dut1)
