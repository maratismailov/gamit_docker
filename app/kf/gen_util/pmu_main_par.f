CTITLE PMU_RIGIDBODY
 
      subroutine pmu_rigidbody(  deriv, pos, comp, ut1_val )

      implicit none 
 
 
*     Routine to compute the partials of rigid body rotation 
*     about the polar motion axes and with the same conventions
*     as polar motion and ut1.  (NOTE: Since rigid body rotation
*     angles are opposite sign to standard PMU partials in pmu_part)
