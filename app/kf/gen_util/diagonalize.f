ctitle
C
      subroutine diagonalize( h, n, iegen, u, nr, x, rap)
...
c
      integer*4 n, nr, iegen
      real*8 h(3,4), u(3,4), x(3)
...
C
      integer*4 iq(3), i,j,k, ipl1, nmi1, ipiv, jpiv
