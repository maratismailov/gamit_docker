       SUBROUTINE DEHANTTIDEINEL(XSTA,T,FHR,XSUN,XMON,DXTIDE)
*
* MOD AZ 190305: subroutine called in theory.f
* Input: site_pos jd_cent fhr sunf moonf
* Output: dXYZ_etide
* Original comments of IERS routines kept for further elaboration
* Conversion of time is commented out in this routine (Line 325-343)
* since this is done before call of this.
* jd_cent -> T is already Julian centuries
* fhr -> FHR is already UTC time
*
*  - - - - - - - - - - - - - - - 
...
*-----------------------------------------------------------------------
     ...
     .                 FHR,H20,L20,H3,L3,H2,L2,SCS,RSTA,SCM,RSUN,
     ...
     .                 FAC3MON,T,PI,SINPHI,COSLA,SINLA,
     .                 DR,DN
