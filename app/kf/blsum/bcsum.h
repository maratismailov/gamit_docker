...
c sumcomp_file  -- file for the summary of the components
c
      character*128 solution_file(max_files), summary_file, 
     .              values_file, sumcomp_file
...
c min_out   -- Minium number of values needed for a summary output.
...
c
      real*8 ref_epoch, ref_length(4), min_epoch, max_epoch, 
     .    mean_epoch, wgh_mean(4), sig_mean(4), intercept(4), 
     .    slope(4), sig_slope(4)
...
c
      real*8 wrms_mean(4), nrms_mean(4), wrms_slope(4), nrms_slope(4)
...
c
      real*8 norm_eq(3,4), b_vec(2,4), stat(4,2,4)
