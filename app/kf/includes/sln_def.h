...
*     See definition as ggamit_mod in globk_cntl.h

      integer*4 sgamit_mod

*  MOD TAH 050622: added Load model bit map
*   sload_mod   - Bit mapped word for cload_mod
...
* MOD TAH 050622 : Used 1 I*4 word, Leaving 2 I*4 words. (sload_mod).
*----------------------------------------------------------------
...
*     Common Declaration
     ...
     .    sexpt_title, sgamit_mod, sload_mod,
     .    sln_dummy
