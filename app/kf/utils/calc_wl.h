...
*                                                                      *
*     EMA/VMA common block for calc_wl.  As the KalObs files are      *
...
*                               -   KalObs file
      ...
      parameter (max_obs = 5000)
 
***** Header information for "X-"  and "S-" files
 
*       calc_wl_cont(3)        - Flags for calculating
*                               -   group-phase-rate ionosphere
 
      logical calc_wl_cont(3)
...
*       sx_KalObs(2)                  - KalObs file descriptor
      ...
      common / sx_header / calc_wl_cont, sx_num_obs, sx_site_names,
...
*       sx_phs_ref(2) - Phase reference frequencies at X and S
*       tc  - Ionspheric corrected delay (group, ps)
*       tg  - Inopsheric delay (group, ps)
*       wlg - Group delay contribution to WL (ps)
*       wlp - Phase delay contribution to WL (ps)
*       wl  - Widelane (cycles)
 
      real*8 sx_epoch(max_obs,2), sx_eff_frq(3,max_obs,2),
     .    sx_ion_cont(3,max_obs), sx_omc(3,max_obs,2),
     .    sx_phs_ref(2), tc, tg, wlg, wlp, wl
