...
*   max_len             - Maximum length to be considered.
...
* COMMON DECLARATION.
      ...
      common / ppb_com / length, wrms, chi, max_len, bvec_av, norm_av,
     .    bvec_st, norm_st, hs_av, us_av, hs_st, us_st, 
     .    hs_apr_av, us_apr_av, hs_apr_st, us_apr_st, num_sites,
