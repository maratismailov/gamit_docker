...
*  T_apr(3)     - Apriori value of Theta
...
*  Xdd_comp(3)      - Computed accelerations
*  Td_obs(3)        - Thres observed rotation rates
*  td_comp(3)       - Computed rates
     ...
     .       Tdb_apr_sig(3), ep_inert, T_apr(3) , 
     .       Xdd_obs(3), Td_obs(3) , Xdd_comp(3), td_comp(3) 

*  true_xyz(3) - True position
*  true_vel(3) - True velocity
*  true_acc(3) - True acceleration
*  true_T(3)   - True orientation (yaw, pitch and roll)
*  true_Td(3)  - True orientation rates

*  PL1_err(max_sat) - Current simulation errors in range
*  Xdd_err(3)  - Current accelerometer errors
*  Td_err(3)   - Current Gyro errors

*  PL1_err_mod(3)  - Error model, WN, FOGM and tau
*  Xdd_err_mod(3)  - Error model for acc
*  Td_err_mod(3)   - Error model for Gyro

*  gps_out_epoch(2) - Range of time with no GPS.

      real*8 true_xyz(3), true_vel(3), true_acc(3) ,
     .       true_T(3) , true_Td(3),
     .       PL1_err(2,max_sat) , Xdd_err(2,3), Td_err(2,3),
     .       PL1_err_mod(3),  Xdd_err_mod(3), Td_err_mod(3),
     .       gps_out_epoch(2)

      real*8 yaw, yaw_prev, pitch, pitch_prev, roll, roll_prev
      real*8 Rgton(3,3), Rntob(3,3), Rgtob(3,3), dRda(3,3,3)
...
*---------------------------------------------------------------
     ...
     .    Td_data, Td_sig , Xdd_data, Xdd_sig , T_apr,
     .    X_apr_sig, Xd_apr_sig , Xdd_apr_sig ,
     .    Xddb_apr_sig , T_apr_sig , Td_apr_sig,
     .    Tdb_apr_sig, ep_inert,
     .    Xdd_obs, Td_obs, Xdd_comp, Td_comp,
     .    true_xyz, true_vel, true_acc ,
     .    true_T , true_Td,
     .    PL1_err , Xdd_err, Td_err,
     .    yaw, yaw_prev, pitch, pitch_prev, roll, roll_prev,
     .    Rgton, Rntob, Rgtob, dRda, 
     .    PL1_err_mod,  Xdd_err_mod, Td_err_mod, gps_out_epoch,
