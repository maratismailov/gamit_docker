      subroutine mag13 (FNM,ITYPE,IOPT,IDM,DATE,ALT,XLT,XLN,NAME,X,Y,Z,F
     . ,debug)
...
C
C Routine modified from igrf13.f TAH 2020/01/24.
C https://www.ngdc.noaa.gov/IAGA/vmod/igrf13.f
C See https://www.ngdc.noaa.gov/IAGA/vmod/igrf.html
C 
...
c      WRITE(6,*)'******************************************************'
        if(debug.ge.3) then
       WRITE(6,*)'MODEL\mag *     IGRF SYNTHESIS PROGRAM IGRF13  *'
        endif
