C*
      SUBROUTINE acc_albedo_propboxw(BLKNUM,AREA,REFL,DIFU,ABSP,AREA2,REFL2,DIFU2,
...
CC
CC            :  GFZ AC Team (P. SAKIC, B. MAENNEL, A. BRACK)
CC               pierre.sakic@gfz-potsdam.de
CC               benjamin.maennel@gfz-potsdam.de
CC               brack@gfz-potsdam.de
CC
CC VERSION    :  1.1 (JUL 2019)
CC
CC CREATED    :  2010/10/18             LAST MODIFIED :  04-JUL-19
CC
...
C     NO (YET) INFORMATION AVAILABLE FOR GLONASS-K
     ...
     1  .OR.(BLKNUM.GE.103.AND.BLKNUM.LE.200)
     2  .OR.(BLKNUM.GE.203)) THEN
      ...
      END SUBROUTINE acc_albedo_propboxw
