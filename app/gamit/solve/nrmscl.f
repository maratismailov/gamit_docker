c
      SUBROUTINE NRMSCL(SCALE,NCOEF,IFLAG,IFLAG2)
      ...
      integer idiag,ij,ncoef,iflag,iflag2,i,j

      REAL*8 SCALE(MAXPRM),DIGT
...
C.....COMPUTE SCALE FACTORS FOR THE NORMAL EQUATIONS
     ...
     . ,' of normal equations not positive (=',digt,'); set = 1.0'
      call report_stat('WARNING','SOLVE','nrmscl',' ',message,0)
      SCALE(I)=1.D0
