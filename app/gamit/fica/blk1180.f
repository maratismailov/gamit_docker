...
c     Read a FICA BLK 1180 for the MINIMAC
c     K. Feigl April 1989
c
c
c--------------------------------------------------------------------------------
c
...
CD     if (debug) print *,'BLK1180: week ',week,' sec of week ',gpssec(1)
CD     if (debug) print *,'BLK1180: PRNs           ',(svid(i),i=1,4)
CD     if (debug) print 203,' BLK1180: L1 phases      ',(dofl1(i),i=1,4)
CD     if (debug) print 203,' BLK1180: L2 phases      ',(dofl2(i),i=1,4)
CD     if (debug) print 203,' BLK1180: L1 amplitudes ',(denrat(i,1),i=1,4)
CD     if (debug) print 203,' BLK1180: L2 amplitudes ',(denrat(i,2),i=1,4)
