...
c     Read a FICA BLK 1380 for the Rogue (from CIGNET)
c     R. King   28 Dec 1990
c
c
c--------------------------------------------------------------------------------
c
...
CD     if (debug) print *,'BLK1380: week ',week,' sec of week ',gpssec(1)
CD     if (debug) print *,'BLK1380: PRNs           ',(svid(i),i=1,4)
CD     if (debug) print 203,' BLK1380: L1 phases      ',(dofl1(i),i=1,4)
CD     if (debug) print 203,' BLK1380: L2 phases      ',(dofl2(i),i=1,4)
CD     if (debug) print 203,' BLK1380: L1 amplitudes ',(denrat(i,1),i=1,4)
CD     if (debug) print 203,' BLK1380: L2 amplitudes ',(denrat(i,2),i=1,4)
