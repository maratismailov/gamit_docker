...
c     Read a FICA BLK 70 (GESAR or CORE) for the TI 4100
...
c--------------------------------------------------------------------------------
c
c    Provisional MIT Definition of reduced FICA TI4100 Data Block  Feigl 08-30-88
c
c   FIC Block Name         : Tracking data (reduced)
c   FIC Block Number       : 70
...
c     set the time tags
 ...
 10      format (1X,'BLK70 WARNING Week number from Block 70 is ',i5,
...
c     seconds from the start of the scenario
      ...
      if (debug) print *, 'In BLK70: dt (seconds) = ', dt
...
c         subtract 7600 to remove this bias
          ...
          if (debug) then
             print *, 'In BLK70: biased phases L1, L2 ',
     .       biasph_l1, biasph_l2
          endif
...
CD     print *,'BLK70: week ',igpswk(1),' sec of week ',gpssec(1)
CD     print *,'BLK70: PRNs           ',(svid(i),i=1,4)
CD     print *,'BLK70: tracker modes  ',(tmode(i),i=1,4)
CD     print 203,' BLK70: L1 unbiased ph ',(dofl1(i),i=1,4)
CD     print 203,' BLK70: L2 unbiased ph ',(dofl2(i),i=1,4)
CD     print 203,' BLK70: L1 pseudoranges',(prgl1(i),i=1,4)
CD     print 203,' BLK70: L2 pseudoranges',(prgl2(i),i=1,4)
