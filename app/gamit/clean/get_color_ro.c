 ...
 * MOdified by Burc Oral  Mon Mar  1 22:09:59 EST 1993
 * read-only colors are allocated.
 * IF YOUR TERMINAL D O E S   N O T   support color, this routine will exit to monochrome
 */
#include <X11/Xlib.h>
#include <X11/Xutil.h>
#include <X11/Xos.h>
...
int get_colors()
{
	...
	static char *name[] = { "DarkOliveGreen","wheat","sandy brown"};
	XColor exact_def;
	...
	while (!XMatchVisualInfo(display, screen, default_depth, /* visual class */i--, &visual_info))
		;
