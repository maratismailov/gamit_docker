...
c  rwk 131025: The start/end times changed from integer to real; apparently
c              ok since not used currently anywhere in gamit.
      real*4 atmll_start,atmlg_start,metl_start,metg_start
     ...
     .            , mapl_int,mapg_int,atll_int,atlg_int
...
c Insititutional source, latitude order,units, and wave names of OTL grid
      real*4 otlgunits
      character*3 otllsrc,otlgsrc
      character*1 otlgns
      common/otlsource/otlgunits,otllsrc,otlgsrc,otlgns
