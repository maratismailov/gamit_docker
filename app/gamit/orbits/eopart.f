...
c
c PARAMETERS:
c         IN: xpole   : xpole rotation angle (rad)                 R*8
c             ypole   : ypole rotation angle (rad)                 R*8
...
CC     write(*,30) ((xpolemat(i,j),j=1,3),i=1,3)
...
CD 200    format(' (dX/dYp)  :',/,3(1x,3D22.14,/))
       do i=1,3
...
CD 290    format(' (dX/dut1dot)  :',/,3(1x,3D22.14,/))
       do  i=1,3
         ut1part(i,2) = temp6(i)*radsec
       enddo
       
CD       write(*,300) ut1part
CD 300    format(' EOPART - ut1part: ',/,3(1x,3D22.14,/))
CD       write(*,310) polepart
CD 310    format(' EOPART - polepart: ',/,4(1x,3D22.14,/))
