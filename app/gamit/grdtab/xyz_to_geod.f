      ...
      Subroutine xyz_to_geod(site_pos, latd, lond, ht )
...
*     Subroutine adapted from tah /kf/gen_util/XYZ_TO_GEOD.  rwk 080115
* 
*     site_pos(3) : XYZ in meters
...
*               - coordinates.
     ...
     .    latd, lond, ht, earth_flat, earth_rad, pi
