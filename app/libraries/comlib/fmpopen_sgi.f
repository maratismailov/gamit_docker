...
* MOD SSS 980701: Ported to SGI - change in open statement:
*     record length should not be multiplied by 4 with SGI.
*
*     DCB(#) - Meaning
...
*   createopen          - Create open
      ...
      logical readopen, writeopen, openopen, createopen
...
cSSS >> 1 July 1998
     .    access = access, recl=recl, form='unformatted' )
c     .    access = access, recl=recl*4, form='unformatted' )
cSSS <<
