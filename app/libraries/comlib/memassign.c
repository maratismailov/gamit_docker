/* 
   memassign.c
     ...
     mem_i4  -- Number of I*4 works to be assigned
...
F_PTR_SIZE memassign_(int *numwords, int *sizeword, long *vma_data) {
...
F_PTR_SIZE memassign(int *numwords, int *sizeword, long *vma_data) {
/* Get the meomory address as 64-but integer for large memory
  machines */
int *memad ; /* Address where memory is available */
long size  ; /* Number of bytes to be assigned */
